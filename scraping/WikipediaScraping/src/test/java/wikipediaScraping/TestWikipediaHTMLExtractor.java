...
public class TestWikipediaHTMLExtractor {
	...
	@Test
	public void testScraper_build_table_sample() throws IOException{
		// Build csv file with a sample of link present in the file wikiurls.txt
	...
	/*@Test
	public void testScraper_build_table_all() throws IOException{
		
		// Build csv file with all the link present in the file wikiurls.txt
