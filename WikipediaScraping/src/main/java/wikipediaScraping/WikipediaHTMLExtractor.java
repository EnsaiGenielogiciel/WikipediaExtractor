...
public class WikipediaHTMLExtractor {
	...
	// Instantation of class attribute
	...
	public WikipediaHTMLExtractor(String root_url, String page_name) {
		/*
		 - root_url : the root of http url (ex : https://en.wikipedia.fr)
		 - page_name : the name of the page to request (ex : Comparison_of_World_War_I_tank)
		 - tables : element that will contain all the html tag of tables which are present in the pages 
		 */
	...
	//Method to check if the cast of string allow to obtain and integer
